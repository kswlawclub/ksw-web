...
const positionRoleGuides: Record<string, PositionRoleGuide> = {
  GK: {
    main: ["เฝ้าประตูและสั่งการแนวรับ", "อ่านจังหวะบอลยาวและช่วยเริ่มเกมจากแดนหลัง"],
    inPossession: ["เปิดบอลให้ปลอดภัย", "เป็นตัวเลือกให้กองหลังคืนบอล", "ช่วยชะลอเกมเมื่อทีมต้องการตั้งหลัก"],
    outOfPossession: ["ยืนตำแหน่งให้พร้อมรับลูกยิง", "สื่อสารกับกองหลังตลอด", "ออกมาตัดบอลเมื่อมั่นใจ"],
  },
  LB: {
    main: ["ยืนคุมพื้นที่ริมเส้นฝั่งซ้าย", "ดูแลปีกคู่แข่งและช่วยเซ็นเตอร์แบ็ก"],
    inPossession: ["เติมเกมเมื่อมีพื้นที่", "สนับสนุนปีกซ้าย", "เปิดบอลหรือจ่ายบอลง่ายให้เพื่อน"],
    outOfPossession: ["รีบถอยกลับตำแหน่ง", "บีบไม่ให้คู่แข่งเปิดบอลง่าย", "ระวังพื้นที่ด้านหลังตัวเอง"],
  },
  RB: {
    main: ["ยืนคุมพื้นที่ริมเส้นฝั่งขวา", "ดูแลปีกคู่แข่งและช่วยเซ็นเตอร์แบ็ก"],
    inPossession: ["เติมเกมเมื่อมีพื้นที่", "สนับสนุนปีกขวา", "เปิดบอลหรือจ่ายบอลง่ายให้เพื่อน"],
    outOfPossession: ["รีบถอยกลับตำแหน่ง", "บีบไม่ให้คู่แข่งเปิดบอลง่าย", "ระวังพื้นที่ด้านหลังตัวเอง"],
  },
  CB: {
    main: ["คุมพื้นที่หน้าประตูและป้องกันกองหน้า", "สื่อสารกับเพื่อนแนวรับให้ยืนเป็นแผง"],
    inPossession: ["จ่ายบอลออกจากแดนหลังอย่างใจเย็น", "หาทางส่งให้กองกลางหรือแบ็ก", "ไม่เสี่ยงเล่นยากหน้าเขตโทษ"],
    outOfPossession: ["ประกบกองหน้าให้แน่น", "เคลียร์บอลเมื่อจำเป็น", "คุมระยะห่างกับเซ็นเตอร์อีกคน"],
  },
  LWB: {
    main: ["รับผิดชอบริมเส้นฝั่งซ้ายทั้งเกมรับและเกมรุก", "ช่วยสร้างความกว้างให้ทีม"],
    inPossession: ["เติมสูงเพื่อเปิดทางริมเส้น", "หาจังหวะครอสหรือจ่ายย้อน", "ประสานงานกับกองกลางฝั่งซ้าย"],
    outOfPossession: ["รีบถอยลงมาเป็นแนวรับ", "ปิดปีกและแบ็กคู่แข่ง", "ไม่ปล่อยพื้นที่ด้านหลังว่าง"],
  },
  RWB: {
    main: ["รับผิดชอบริมเส้นฝั่งขวาทั้งเกมรับและเกมรุก", "ช่วยสร้างความกว้างให้ทีม"],
    inPossession: ["เติมสูงเพื่อเปิดทางริมเส้น", "หาจังหวะครอสหรือจ่ายย้อน", "ประสานงานกับกองกลางฝั่งขวา"],
    outOfPossession: ["รีบถอยลงมาเป็นแนวรับ", "ปิดปีกและแบ็กคู่แข่ง", "ไม่ปล่อยพื้นที่ด้านหลังว่าง"],
  },
  DM: {
    main: ["ยืนหน้าแนวรับและคอยตัดเกม", "ปิดพื้นที่ตรงกลางไม่ให้คู่แข่งเจาะง่าย"],
    inPossession: ["รับบอลจากกองหลัง", "จ่ายบอลง่ายและคุมจังหวะ", "ช่วยเปลี่ยนแกนซ้ายขวา"],
    outOfPossession: ["อ่านจังหวะสวนกลับ", "บีบพื้นที่หน้ากรอบเขตโทษ", "ช่วยซ้อนเพื่อนเมื่อถูกเลี้ยงผ่าน"],
  },
  CM: {
    main: ["เชื่อมเกมระหว่างกองหลังกับแนวรุก", "คุมจังหวะและช่วยไล่บอลตรงกลางสนาม"],
    inPossession: ["หาช่องรับบอล", "จ่ายบอลง่ายและแม่นยำ", "ช่วยเปลี่ยนแกนซ้ายขวา"],
    outOfPossession: ["รีบไล่กดดันคนถือบอล", "ปิดช่องจ่ายบอลตรงกลาง", "ถอยช่วยแนวรับเมื่อจำเป็น"],
  },
  AM: {
    main: ["ยืนระหว่างกองกลางกับกองหน้า", "สร้างโอกาสและหาช่องจ่ายบอลสุดท้าย"],
    inPossession: ["หาพื้นที่รับบอลระหว่างไลน์", "จ่ายทะลุช่องหรือยิงเมื่อมีโอกาส", "ช่วยเชื่อมกับกองหน้า"],
    outOfPossession: ["กดดันมิดฟิลด์คู่แข่ง", "ปิดทางจ่ายบอลเข้ากลาง", "ถอยมาช่วยแดนกลางเมื่อทีมเสียเปรียบ"],
  },
  LAM: {
    main: ["ยืนตัวรุกฝั่งซ้ายและช่วยเชื่อมเกม", "หาพื้นที่ระหว่างแบ็กกับเซ็นเตอร์คู่แข่ง"],
    inPossession: ["ลากตัดเข้าในหรือจ่ายทะลุช่อง", "ประสานงานกับปีกและกองหน้า", "หาจังหวะยิงจากหน้าเขตโทษ"],
    outOfPossession: ["ช่วยบีบทางซ้าย", "ปิดตัวจ่ายบอลของคู่แข่ง", "ถอยช่วยกองกลางเมื่อจำเป็น"],
  },
  RAM: {
    main: ["ยืนตัวรุกฝั่งขวาและช่วยเชื่อมเกม", "หาพื้นที่ระหว่างแบ็กกับเซ็นเตอร์คู่แข่ง"],
    inPossession: ["ลากตัดเข้าในหรือจ่ายทะลุช่อง", "ประสานงานกับปีกและกองหน้า", "หาจังหวะยิงจากหน้าเขตโทษ"],
    outOfPossession: ["ช่วยบีบทางขวา", "ปิดตัวจ่ายบอลของคู่แข่ง", "ถอยช่วยกองกลางเมื่อจำเป็น"],
  },
  LM: {
    main: ["คุมพื้นที่ริมเส้นฝั่งซ้าย", "ช่วยทั้งเกมรุกและเกมรับด้านซ้าย"],
    inPossession: ["หาพื้นที่ริมเส้น", "เปิดบอลหรือจ่ายเข้ากลาง", "ช่วยแบ็กซ้ายเล่นบอล"],
    outOfPossession: ["ตามแบ็กหรือปีกคู่แข่ง", "ปิดทางเปิดบอล", "ถอยช่วยแบ็กซ้ายเมื่อถูกบุก"],
  },
  RM: {
    main: ["คุมพื้นที่ริมเส้นฝั่งขวา", "ช่วยทั้งเกมรุกและเกมรับด้านขวา"],
    inPossession: ["หาพื้นที่ริมเส้น", "เปิดบอลหรือจ่ายเข้ากลาง", "ช่วยแบ็กขวาเล่นบอล"],
    outOfPossession: ["ตามแบ็กหรือปีกคู่แข่ง", "ปิดทางเปิดบอล", "ถอยช่วยแบ็กขวาเมื่อถูกบุก"],
  },
  LW: {
    main: ["โจมตีริมเส้นฝั่งซ้ายและสร้างโอกาส", "ดึงแนวรับคู่แข่งให้เปิดพื้นที่"],
    inPossession: ["เลี้ยงดวลเมื่อมีจังหวะ", "เปิดบอลหรือจ่ายเข้ากลาง", "วิ่งเข้ากรอบเมื่อบอลมาจากอีกฝั่ง"],
    outOfPossession: ["ช่วยกดดันแบ็กคู่แข่ง", "ถอยช่วยริมเส้นเมื่อจำเป็น", "ไม่ปล่อยให้คู่แข่งสวนกลับง่าย"],
  },
  RW: {
    main: ["โจมตีริมเส้นฝั่งขวาและสร้างโอกาส", "ดึงแนวรับคู่แข่งให้เปิดพื้นที่"],
    inPossession: ["เลี้ยงดวลเมื่อมีจังหวะ", "เปิดบอลหรือจ่ายเข้ากลาง", "วิ่งเข้ากรอบเมื่อบอลมาจากอีกฝั่ง"],
    outOfPossession: ["ช่วยกดดันแบ็กคู่แข่ง", "ถอยช่วยริมเส้นเมื่อจำเป็น", "ไม่ปล่อยให้คู่แข่งสวนกลับง่าย"],
  },
  ST: {
    main: ["ยืนเป็นเป้าหมายในแดนหน้า", "หาจังหวะจบสกอร์และกดดันกองหลังคู่แข่ง"],
    inPossession: ["หาพื้นที่ในกรอบเขตโทษ", "พักบอลให้เพื่อนเติม", "ยิงเมื่อมีโอกาส"],
    outOfPossession: ["เริ่มกดดันจากแดนบน", "บังทางจ่ายบอลกลับหลัง", "ช่วยทีมไม่ให้คู่แข่งขึ้นเกมง่าย"],
  },
  CF: {
    main: ["เชื่อมเกมระหว่างแนวรุกและกองกลาง", "ดึงกองหลังออกจากตำแหน่งเพื่อเปิดพื้นที่"],
    inPossession: ["ถอยมารับบอลและจ่ายต่อ", "หมุนตัวหาช่องยิงหรือจ่าย", "ประสานงานกับปีกสองข้าง"],
    outOfPossession: ["กดดันเซ็นเตอร์คู่แข่ง", "ปิดทางจ่ายเข้ากลาง", "รีบกลับมาช่วยเมื่อทีมเสียบอล"],
  },
  SS: {
    main: ["เล่นหลังกองหน้าและคอยเก็บบอลจังหวะสอง", "เชื่อมเกมรุกกับหน้าเป้า"],
    inPossession: ["หาช่องระหว่างไลน์", "จ่ายบอลให้กองหน้าหรือยิงเอง", "เติมเข้ากรอบในจังหวะเหมาะสม"],
    outOfPossession: ["กดดันมิดฟิลด์รับคู่แข่ง", "ปิดทางจ่ายบอลแรก", "ถอยช่วยแดนกลางเมื่อจำเป็น"],
  },
};
...
export function LineupBuilderClient({ members, opponents }: LineupBuilderProps) {
  ...
  function renderPlayerPicker(positionIndex: number) {
    ...
    const roleGuide = positionRoleGuides[position.label];
    ...
    return (
      <div className="flex max-h-full min-h-0 flex-col">
        ...
        >
          ...
          {roleGuide ? (
            <div className="mt-3 grid gap-3 text-xs font-semibold leading-5 text-slate-200 sm:grid-cols-3">
              <div>
                <p className="font-black text-white">หน้าที่หลัก</p>
                <ul className="mt-2 space-y-1">
                  {roleGuide.main.map((item) => (
                    <li className="flex gap-2" key={item}>
                      <span className="mt-2 size-1 shrink-0 rounded-full bg-[#d8ad45]" />
                      {item}
                    </li>
                  ))}
                </ul>
              ...
              <div>
                <p className="font-black text-white">ตอนทีมมีบอล</p>
                <ul className="mt-2 space-y-1">
                  {roleGuide.inPossession.map((item) => (
                    <li className="flex gap-2" key={item}>
                      <span className="mt-2 size-1 shrink-0 rounded-full bg-[#d8ad45]" />
                      {item}
                    </li>
              ...
              <div>
                <p className="font-black text-white">ตอนทีมเสียบอล</p>
                <ul className="mt-2 space-y-1">
                  {roleGuide.outOfPossession.map((item) => (
                    <li className="flex gap-2" key={item}>
                      <span className="mt-2 size-1 shrink-0 rounded-full bg-[#d8ad45]" />
                      {item}
                    </li>
            ...
            <p className="mt-2 text-sm font-bold text-slate-200">
              คำอธิบายตำแหน่งนี้กำลังจัดเตรียมเพิ่มเติม
            </p>
          )}
        </div>
