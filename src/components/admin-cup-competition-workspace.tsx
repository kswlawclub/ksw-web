...
function CupCompetitionProgress({ steps }: { steps: CupCompetitionWorkflowStep[] }) {
  ...
  const presentation = {
    ...
    current: { className: "border-[#d8ad45]/40 bg-[#fff7e6] text-[#8a6418]" },
